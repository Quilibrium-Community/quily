...
- optimized TUI display and interactions
...
- corrected reward calculations and logical shard counts in worker TUI
...
- prevented shutdown loops and added worker naming for tracing
...
- improved respawn logic and added isolation logging for quirks
...
- fixed blossomsub peer scoring parameter initialization
...
- fixed edge case in peer scoring during network partitions
- improved error handling in DHT operations
- resolved race condition in peer connection lifecycle
- optimized bloom filter usage for sync operations
