...
- fix race condition where sync workers could become permanently idle after initial failure
- fix transaction safety for hyper

## v2.1.0.21 (version .21) *(auto-generated)*
- reconciled old and new config paths
- fix formatting/precision on prover reward data and potential peering issue
- fix app shard lookups on mainnet

## v2.1.0.20 (version .20) *(auto-generated)*
- added debug mode via `DEBUG` environment variable
...
- resolve signature failure with additional merge-related error logging
...
- add reconnect fallback with variable reconnect time if no peers found (#511)
