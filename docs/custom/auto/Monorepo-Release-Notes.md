...
- enhance error logging for merge-related signatures
- fix seniority marker join blocker
- fix sync message size limit defaults
- resolve signature failure
- fix one-shot sync message size, app shard TC signature size
...
- fix worker manager refreshes filter on allocation
...
- integrate shutdown context to PerformSync to prevent stuck syncs
...
- fix restore proper respawn logic
